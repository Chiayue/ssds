return {
	...
	{	-- 2
		...
		model_scale = 1,
		wearables = {
			{model = "models/items/arc_warden/arctic_warden_arms/arctic_warden_arms.vmdl", particle_systems = {}},
			{model = "models/items/arc_warden/arctic_warden_back/arctic_warden_back.vmdl", particle_systems = {}},
			{model = "models/items/arc_warden/arctic_warden_shoulder/arctic_warden_head.vmdl", particle_systems = {}},
			{model = "models/items/arc_warden/arctic_warden_shoulder/arctic_warden_shoulder.vmdl", particle_systems = {}},
		},
