LinkLuaModifier("modifier_drow_ranger_3", "abilities/drow_ranger_3.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_drow_ranger_3_projectile", "abilities/drow_ranger_3.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_drow_ranger_3_ignore_armor", "abilities/drow_ranger_3.lua", LUA_MODIFIER_MOTION_NONE)
--Abilities
